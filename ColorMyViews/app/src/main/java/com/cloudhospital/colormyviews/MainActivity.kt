package com.cloudhospital.colormyviews
...
import com.cloudhospital.colormyviews.databinding.ActivityMainBinding
...
//        setContentView(R.layout.activity_main)
    ...
    private fun setListeners() {
        val clickableViews: List<View> =
            listOf(binding.boxOneText, binding.boxTwoText, binding.boxThreeText, binding.boxFourText, binding.boxFiveText, binding.redButton, binding.greenButton, binding.yellowButton, binding.constraintLayout )
